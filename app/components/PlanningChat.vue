            ...
            <div class="space-y-5">
              <section class="glass-card p-4">
                ...
                <div v-else class="mt-4 rounded-glass border border-dashed border-border-subtle bg-white/[0.03] px-4 py-6 text-center text-sm text-text-muted">
                  ...
                  >
                    <div class="text-xs font-semibold uppercase tracking-wide text-amber-800">M�gliche Duplikate</div>
                    <div class="mt-2 space-y-2">
                      ...
                      >
                        <div class="text-xs font-medium text-gray-900">{{ duplicate.event.summary || '�hnlicher Termin' }}</div>
                ...
                <div v-else-if="previewRoutine && parsedDetails" class="mt-3 space-y-3">
                  ...
                  <div
                    ...
                    class="rounded-xl border border-amber-200 bg-amber-50 px-4 py-3"
                  >
                    <div class="text-xs font-semibold uppercase tracking-wide text-amber-800">Bereits �hnliche Routinen im Kalender</div>
                    <div class="mt-2 space-y-2">
                      <div
                        v-for="duplicate in routineDuplicateWarnings"
                        :key="duplicate.label"
