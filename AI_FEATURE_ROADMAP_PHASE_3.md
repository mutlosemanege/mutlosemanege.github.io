...
- [x] Batch-Aktionen robuster gegen Teilfehler machen
- [x] Lokale Recovery-Hinweise fuer abgebrochene Sync-Sequenzen ergaenzen
...
- [x] Scheduler bei vielen Tasks und Events profilieren
- [x] Wiederholte Slot-Berechnungen reduzieren oder cachen
- [x] Grosse Aufgabenlisten und Projektgruppen auf unnoetige Re-Renders pruefen
- [x] Langsame Planungsansichten sichtbar mit leichteren Loading-States abfedern

## 20. Planungsqualitaet bei Grenzfaellen
- [x] Mehrtaegige Termine, ganztagige Events und Randfaelle um Mitternacht gezielt absichern
- [x] DST-/Zeitzonen-Randfaelle fuer Kalender und Chat-Vorschlaege abdecken
- [x] Wiederkehrende Routinen mit Ausnahmen und Feiertagen noch staerker zusammendenken
- [x] Unschaerfen im Chat bei mehrdeutigen Zeitangaben noch klarer machen
